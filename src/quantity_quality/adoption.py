...
COMMON_NOTATION_EXAMPLES: List[dict] = [
    {
        ...
        "notation": format_energy_notation(1, "MWh", 1.0),
    ...
    },
    {
        ...
        "notation": format_energy_notation(1, "MWh_cooling", 0.082),
...
STANDARD_INTEGRATION_POINTS = [
    {
        ...
        "adoption_path": "Use f_X as a supplemental energy performance indicator alongside kWh, cost, and emissions.",
    },
    {
        "standard": "IPMVP measurement and verification",
        "adoption_path": "Report both energy savings and avoided accessible exergy: delta X_A = f_X,baseline E_baseline - f_X,post E_post.",
    },
    {
        "standard": "ISO 14040 life-cycle assessment",
        "adoption_path": "Attach f_X to energy and material flow inventory lines so low-grade heat, fuels, and electricity are not collapsed into identical MWh.",
    },
    {
    ...
    },
    {
        ...
        "adoption_path": "Require every quoted energy stream to declare quantity, f_X, reference, boundary, and basis.",
    },
]
